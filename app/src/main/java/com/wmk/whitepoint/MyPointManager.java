...
import com.wmk.whitepoint.View.BigFloatWindowView;
...
public class MyPointManager {
     ...
     *            必须为应用程序的Context.
     */
    public static BigFloatWindowView createBigWindow(Context context) {
        WindowManager windowManager = getWindowManager(context);
        int screenWidth = windowManager.getDefaultDisplay().getWidth();
        int screenHeight = windowManager.getDefaultDisplay().getHeight();
        if (bigWindow == null) {
            ...
            if (bigWindowParams == null) {
                ...
                bigWindowParams.x = screenWidth / 3  - BigFloatWindowView.viewWidth / 3;
                bigWindowParams.y = screenHeight / 3  - BigFloatWindowView.viewHeight / 3;
